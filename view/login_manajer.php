...
<head>
    ...
    <title>Kokeru - Login Manajer</title>
...
<body oncontextmenu='return false' class='snippet-body'>
    ...
    if (isset($_POST["submit"])) {
        ...
        if ($valid) {
            $query = " SELECT * FROM manajer WHERE email_manajer='" . $email . "'AND pass='" . $password . "' ";
            ...
            if (!$result) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    $_SESSION['name'] = $result->nama_manajer;
            ...
            <div class="col-md-6">
                <div class="card">
                    <form class="box" method="POST" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <a class="forgot text-muted" href="login_cs.php">Login CS</a>
                        <br>
